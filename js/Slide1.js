var ViewsOverTime={
    display: async function() {
        ...
        d3.select("#ViewsOverTime").selectAll("#categoryDiv1").remove();
        d3.select("#ViewsOverTime").selectAll("#categoryButton1").remove();
        ...
        d3.select("#ViewsOverTime").append("div")
            .attr("id", "categoryDiv1")
            .append("label")
            .text("Select a Category: ")
            .attr("style", "font-size:15px;font-family:Arial;font-weight: bold;color:#2C5F2D;");         
        d3.select("#ViewsOverTime")
            .select("#categoryDiv1")
            .append("select")
            .attr("id", "categoryButton1")
            .selectAll("myOptions")
            .data(category_name)
            .enter().append("option")
            .text(function (d) { return d; })
            .attr("value", function(d) { return d; })
        d3.select("#categoryButton1")
        ...
        var circles = svg.append("g")
            ...
            .enter()
            .append("circle")
            .attr("cx", function(d,i) { return xdates[i]; })
        ...
        const xAxis = d3.axisBottom(xdate);
...
//=====================================================================================================
        ...
        var dv_tooltip = d3.select("#ViewsOverTime")
            .append("div")
            .attr("class", "tooltip")
            .style("display", "none");
